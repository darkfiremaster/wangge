...
public enum HuaweiGroupServiceDayUrlEnum {
    ...
    CREATE_GROUP_SERVICE_DAY("/CMCC_GX_market/api/v2/addGroupSerPlan","新建集团服务日计划","","createGroupServiceDay"),
    UPDATE_GROUP_SERVICE_DAY("/CMCC_GX_market/api/v2/updGroupSerPlan","更新集团服务日计划","","updateGroupServiceDay"),
