...
//import com.shinemo.cmgr.vo.FileVo;
...
//
//    @Resource
//    private TinyfsClient tinyfsClient;
//    @Resource
...
//
//            // 下载文件
//            int ret = tinyfsClient.getFile(id, (byte) 2, data, finished);
...
//            int ret = tinyfsClient.addFile((byte) 2, file.getBytes(), false, true, fileId);
