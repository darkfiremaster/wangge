...
//		    .build();
    ...
    public ApiResult<List<GridUserRoleDetail>> getGridUserInfo(HuaWeiRequest request) {
        ...
        //todo mock待删除
        if (!EnvUtil.isOnline()) {
            List<String> list = Arrays.asList("18523280364", "15797953927", "13107701611", "15958032925", "18790513853", "15226536886", "15000001171", "18850583991", "13396631940", "18790513853", "13588039023", "13107701611", "18776892034","13407710166");
