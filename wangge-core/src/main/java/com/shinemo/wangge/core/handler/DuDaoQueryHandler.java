...
@Slf4j
@Component
public class DuDaoQueryHandler extends DuDaoCommonHandler {
	/**
	 * 路径
	 */
	@Setter
	...
	public String getUrl(UrlRedirectHandlerRequest request) {
		...
		String methodName = duDaoParams == null ? null : duDaoParams.getMethodName();
		...
		if (methodName != null) {
			formData.put("methodName", methodName);
		}
